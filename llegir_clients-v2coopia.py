...
while sortir == False:	
	...
	os.system('clear')
	print "OPCIONS \n 1- Poder indicar la tabla que quiera :: \n 0- Sortir \n"
	...
	# Llegim la taula "clientes"
		...
		try:			
				nombretabla = raw_input ("indique su tabla : ")
				...
				if nombretabla == 'pedidos' :
					...
					#print row[0],row[1],row[2],row[3]
						print(" {:^10} {} {:^10} {:^10} {:^10} {} {:^10} {:^10} ".format(row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7]))
